          ...
          <Dialog.Overlay className='bg-black/60 inset-0 fixed'>
            <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-10 left-1/2 -translate-x-1/2 rounded-lg w-[520px] shadow-black/40 '>
              <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
                <form onSubmit={handleCreatAd} className='mt-8 flex flex-col gap-2  '>
                  ...
                  <div className='flex flex-col gap-2 '>
                    ...
                    <Input name='name' id='name' placeholder='Seu nome dentro no Game?' />
                  </div>

                  <div className=' grid grid-cols-2 gap-4 '>
                    <div className=' flex flex-col gap-2 '>
                      <label htmlFor="yearsPlaying">Joga há quantos anos ?</label>
                      <Input name='yearsPlaying' id='yearsPlaying' placeholder='Joga há quantos anos ?' />
                    </div>
                    <div className='flex flex-col gap-2'>
                      <label htmlFor="discord">Qual é o seu Discord?</label>
                      <Input name='discord' id='discord' type='text' placeholder='Usuario do Discord' />
                  </div>
                  </div>
